        ...
        supprimerBaseDeDonnees(context);
         helper = new SQLiteOpenHelper(context,nomBaseDeDonnees,null,1) {
            ...
            public void onCreate(SQLiteDatabase sqLiteDatabase) {
                ...
                sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS partieDetail (_id INTEGER NOT NULL UNIQUE PRIMARY KEY AUTOINCREMENT, hashPartie TEXT NOT NULL UNIQUE, resultat TEXT NOT NULL, eloJ1 TEXT NOT NULL, eloJ2 TEXT NOT NULL, fiabiliteArbitre REAL CHECK (fiabiliteArbitre BETWEEN 0.0 AND 1.0))");
                sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS leaderboard (_id INTEGER NOT NULL UNIQUE PRIMARY KEY AUTOINCREMENT, clefPublique TEXT NOT NULL UNIQUE, pseudo TEXT NOT NULL, elo TEXT, coefficientArbitrage REAL, scoreTotal REAL, nbParties INTEGER, nbVictoire INTEGER, nbConfirmation INTEGER, nbPartieArbitre INTEGER, nbNul INTEGER, nbDefaite INTEGER)");
